...
function Play() {
    ...
    return (
        // https://soundcloud.com/audiorotica_records/hartshorn-funk-accelerator?utm_source=clipboard&utm_medium=text&utm_campaign=social_sharing
            ...
            <div className="play-section h-28 w-full bg-black p-10 text-white flex justify-between fixed bottom-0 z-10">
                <div className="songdetails font-Roboto flex ">
                    ...
                    <div className="addtofavourites mr-4 mt-3 flex ">
                        <FaRegHeart size={28} className='flex justify-center items-center mr-3 hover:cursor-pointer' />
                ...
                <div className="controller flex flex-col">
                    <div className="songbuttons flex justify-around w-96 pl-4 ">
                        <IoShuffle  size={28} className='smallestDevices:max-smallDevices:invisible hover:cursor-pointer'/>
                        <MdSkipPrevious size={30} className='smallestDevices:max-smallDevices:invisible hover:cursor-pointer'/>
                        <FaPlay size={30} className='hover:cursor-pointer' onClick={PlayPause}  />
                        <MdSkipNext size={30} className='smallestDevices:max-smallDevices:invisible hover:cursor-pointer'/>
                        <RxLoop size={28} className='smallestDevices:max-smallDevices:invisible hover:cursor-pointer'/>
                    </div>
